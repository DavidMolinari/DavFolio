...
MarkerLabel.prototype = new google.maps.OverlayView, MarkerLabel.prototype.onAdd = function () {
    ...
    var e = this.getProjection(), t = e.fromLatLngToDivPixel(this.get("position")), i = this.div;
    ...
    function t(t) {
        var i = t || window.event, n = [].slice.call(arguments, 1), o = 0, s = 0, a = 0, t = e.event.fix(i);
    ...
    var n = e.prototype, o = this, s = o.EventEmitter;
    n.getListeners = function (e) {
        ...
        var n, o = this.getListenersAsObject(e), s = "object" == typeof i;
        for (n in o)o.hasOwnProperty(n) && -1 === t(o[n], i) && o[n].push(s ? i : {listener: i, once: !1});
        return this
        ...
        var n, o, s = e ? this.removeListener : this.addListener, a = e ? this.removeListeners : this.addListeners;
        if ("object" != typeof t || t instanceof RegExp)for (n = i.length; n--;)s.call(this, t, i[n]); else for (n in t)t.hasOwnProperty(n) && (o = t[n]) && ("function" == typeof o ? s.call(this, n, o) : a.call(this, n, o));
        return this
        ...
        for (o in a)if (a.hasOwnProperty(o))for (n = a[o].length; n--;)i = a[o][n], i.once === !0 && this.removeListener(e, i.listener), s = i.listener.apply(this, t || []), s === this._getOnceReturnValue() && this.removeListener(e, i.listener);
        return this
    ...
    var d = e.jQuery, c = e.console, u = void 0 !== c, h = Object.prototype.toString;
    a.prototype = new t, a.prototype.options = {}, a.prototype.getImages = function () {
        ...
        for (var e = 0, t = this.elements.length; t > e; e++) {
            ...
            var n = i.nodeType;
            if (n && (1 === n || 9 === n || 11 === n))for (var o = i.querySelectorAll("img"), s = 0, a = o.length; a > s; s++) {
                var r = o[s];
                this.addImage(r)
            }
        }
            ...
            e.fn[t] = function (o) {
                if ("string" == typeof o) {
                    for (var a = n.call(arguments, 1), r = 0, l = this.length; l > r; r++) {
                        var d = this[r], c = e.data(d, t);
                        if (c)if (e.isFunction(c[o]) && "_" !== o.charAt(0)) {
                            var u = c[o].apply(c, a);
                            if (void 0 !== u)return u
                        } else s("no such method '" + o + "' for " + t + " instance"); else s("cannot call methods on " + t + " prior to initialization; attempted to call '" + o + "'")
                    }
                    return this
                }
    ...
    n.getListeners = function (e) {
        ...
        var t, i = typeof e, n = this._getEvents();
        if ("string" === i) delete n[e]; else if (e instanceof RegExp)for (t in n)n.hasOwnProperty(t) && e.test(t) && delete n[t]; else delete this._events;
        return this
    }, n.removeAllListeners = i("removeEvent"), n.emitEvent = function (e, t) {
        var i, n, o, s, a = this.getListenersAsObject(e);
        for (o in a)if (a.hasOwnProperty(o))for (n = a[o].length; n--;)i = a[o][n], i.once === !0 && this.removeListener(e, i.listener), s = i.listener.apply(this, t || []), s === this._getOnceReturnValue() && this.removeListener(e, i.listener);
    ...
    function t(e) {
        if (e) {
            ...
            for (var t, o = 0, s = i.length; s > o; o++)if (t = i[o] + e, "string" == typeof n[t])return t
        }
    }
    ...
    function s(t) {
        ...
        function s(e) {
            if (n(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                var v = s.paddingLeft + s.paddingRight, y = s.paddingTop + s.paddingBottom, b = s.marginLeft + s.marginRight, w = s.marginTop + s.marginBottom, x = s.borderLeftWidth + s.borderRightWidth, S = s.borderTopWidth + s.borderBottomWidth, C = a && u, T = i(t.width);
        ...
        function l(t, i) {
            ...
            var n = t.style, o = n.left, s = t.runtimeStyle, a = s && s.left;
    ...
    function n(e, t) {
        i(e);
        for (var n = e.parentNode.querySelectorAll(t), o = 0, s = n.length; s > o; o++)if (n[o] === e)return !0;
        return !1
    }
    ...
    var s, a = function () {
        ...
        for (var t = ["webkit", "moz", "ms", "o"], i = 0, n = t.length; n > i; i++) {
            var o = t[i], s = o + "MatchesSelector";
            if (e[s])return s
        }
    }();
    if (a) {
        var r = document.createElement("div"), l = t(r, "div");
        s = l ? t : o
    } else s = n;
    ...
    n.isArray = function (e) {
        ...
        var t = [];
        if (n.isArray(e)) t = e; else if (e && "number" == typeof e.length)for (var i = 0, o = e.length; o > i; i++)t.push(e[i]); else t.push(e);
        return t
    ...
    return n.htmlInit = function (i, o) {
        t(function () {
            for (var t = n.toDashed(o), a = document.querySelectorAll(".js-" + t), r = "data-" + t + "-options", l = 0, d = a.length; d > l; l++) {
                var c, u = a[l], h = u.getAttribute(r);
                try {
                    c = h && JSON.parse(h)
                } catch (p) {
    ...
    var l = e.getComputedStyle, d = l ? function (e) {
            return l(e, null)
        } : function (e) {
            return e.currentStyle
        }, c = n("transition"), u = n("transform"), h = c && u, p = !!n("perspective"), m = {
        WebkitTransition: "webkitTransitionEnd",
        MozTransition: "transitionend",
        OTransition: "otransitionend",
        transition: "transitionend"
    }[c], f = ["transform", "transition", "transitionDuration", "transitionProperty"], g = function () {
    ...
    o.extend(a.prototype, t.prototype), a.prototype._create = function () {
        ...
        var e = d(this.element), t = this.layout.options, i = t.isOriginLeft, n = t.isOriginTop, o = e[i ? "left" : "right"], s = e[n ? "top" : "bottom"], a = this.layout.size, r = -1 != o.indexOf("%") ? parseFloat(o) / 100 * a.width : parseInt(o, 10), l = -1 != s.indexOf("%") ? parseFloat(s) / 100 * a.height : parseInt(s, 10);
        ...
        var e = this.layout.size, t = this.layout.options, i = {}, n = t.isOriginLeft ? "paddingLeft" : "paddingRight", o = t.isOriginLeft ? "left" : "right", s = t.isOriginLeft ? "right" : "left", a = this.position.x + e[n];
        i[o] = this.getXValue(a), i[s] = "";
        var r = t.isOriginTop ? "paddingTop" : "paddingBottom", l = t.isOriginTop ? "top" : "bottom", d = t.isOriginTop ? "bottom" : "top", c = this.position.y + e[r];
        ...
        this.getPosition();
        var i = this.position.x, n = this.position.y, o = parseInt(e, 10), s = parseInt(t, 10), a = o === this.position.x && s === this.position.y;
    ...
    a.prototype.ontransitionend = function (e) {
        if (e.target === this.element) {
            var t = this._transn, i = y[e.propertyName] || e.propertyName;
    ...
    return a.namespace = "outlayer", a.Item = s, a.defaults = {
        ...
        if (this._emitCompleteOnItems("layout", e), e && e.length) {
            for (var i = [], n = 0, o = e.length; o > n; n++) {
                var s = e[n], a = this._getItemLayoutPosition(s);
        ...
        var t = e.getBoundingClientRect(), i = this._boundingRect, o = n(e), s = {
        ...
        e = o.makeArray(e);
        for (var t = [], i = 0, n = e.length; n > i; i++) {
            var s = e[i], a = this.getItem(s);
            a && t.push(a)
        }
        return t
    }, a.prototype.remove = function (e) {
        var t = this.getItems(e);
        if (this._emitCompleteOnItems("remove", t), t && t.length)for (var i = 0, n = t.length; n > i; i++) {
            var s = t[i];
    ...
    return n.prototype._resetLayout = function () {
        ...
        var n = this.columnWidth += this.gutter, o = this.containerWidth + this.gutter, s = o / n, a = n - o % n, r = a && 1 > a ? "round" : "floor";
        s = Math[r](s), this.cols = Math.max(s, 1)
    }, n.prototype.getContainerWidth = function () {
        var e = this.options.isFitWidth ? this.element.parentNode : this.element, i = t(e);
        this.containerWidth = i && i.innerWidth
    }, n.prototype._getItemLayoutPosition = function (e) {
        e.getSize();
        var t = e.size.outerWidth % this.columnWidth, n = t && 1 > t ? "round" : "ceil", o = Math[n](e.size.outerWidth / this.columnWidth);
        ...
        var i = t(e), n = this._getElementOffset(e), o = this.options.isOriginLeft ? n.left : n.right, s = o + i.outerWidth, a = Math.floor(o / this.columnWidth);
        a = Math.max(0, a);
    ...
    var n = e.create("masonry"), o = n.prototype._getElementOffset, s = n.prototype.layout, a = n.prototype._getMeasurement;
    ...
    function r(e, t) {
        return function (i, n) {
            for (var o = 0, s = e.length; s > o; o++) {
                var a = e[o], r = i.sortData[a], l = n.sortData[a];
                if (r > l || l > r) {
                    var d = void 0 !== t[a] ? t[a] : t, c = d ? 1 : -1;
                    return (r > l ? 1 : -1) * c
                }
            }
            return 0
    ...
    var l = e.jQuery, d = String.prototype.trim ? function (e) {
            return e.trim()
        } : function (e) {
            return e.replace(/^\s+|\s+$/g, "")
        }, c = document.documentElement, u = c.textContent ? function (e) {
    ...
    var p = function () {
        function e(e) {
            ...
            var i = d(e).split(" "), n = i[0], o = n.match(/^\[(.+)\]$/), s = o && o[1], a = t(s, n), r = h.sortDataParsers[i[1]];
    ...
    h.sortDataParsers = {
        ...
        if (e) {
            var t = [].concat.apply(e, this.sortHistory), i = r(t, this.options.sortAscending);
    ...
    o.prototype = {
        defaults: {
            ...
            var n = this, o = e(i.currentTarget), s = o.parent(), a = "#" + n.getHash(o);
            ...
            var e, t = this.$win.scrollTop(), i = this.getSection(t);
            ...
            e("html, body").animate({scrollTop: n}, this.config.scrollSpeed, this.config.easing, i)
    ...
    e.fn.bxSlider = function (o) {
        ...
        var s = {}, a = this;
        t.el = this;
        var r = e(window).width(), l = e(window).height(), d = function () {
            s.settings = e.extend({}, n, o), s.settings.slideWidth = parseInt(s.settings.slideWidth), s.children = a.children(s.settings.slideSelector), s.children.length < s.settings.minSlides && (s.settings.minSlides = s.children.length), s.children.length < s.settings.maxSlides && (s.settings.maxSlides = s.children.length), s.settings.randomStart && (s.settings.startSlide = Math.floor(Math.random() * s.children.length)), s.active = {index: s.settings.startSlide}, s.carousel = s.settings.minSlides > 1 || s.settings.maxSlides > 1, s.carousel && (s.settings.preloadImages = "all"), s.minThreshold = s.settings.minSlides * s.settings.slideWidth + (s.settings.minSlides - 1) * s.settings.slideMargin, s.maxThreshold = s.settings.maxSlides * s.settings.slideWidth + (s.settings.maxSlides - 1) * s.settings.slideMargin, s.working = !1, s.controls = {}, s.interval = null, s.animProp = "vertical" == s.settings.mode ? "top" : "left", s.usingCSS = s.settings.useCSS && "fade" != s.settings.mode && function () {
            ...
            a.wrap('<div class="bx-wrapper"><div class="bx-viewport"></div></div>'), s.viewport = a.parent(), s.loader = e('<div class="bx-loading" />'), s.viewport.prepend(s.loader), a.css({
                ...
                overflow: "hidden",
                position: "relative"
            }), s.viewport.parent().css({maxWidth: m()}), s.settings.pager || s.viewport.parent().css({margin: "0 auto 0px"}), s.children.css({
            ...
            if (s.settings.infiniteLoop && "fade" != s.settings.mode && !s.settings.ticker) {
                var t = "vertical" == s.settings.mode ? s.settings.minSlides : s.settings.maxSlides, i = s.children.slice(0, t).clone().addClass("bx-clone"), n = s.children.slice(-t).clone().addClass("bx-clone");
            ...
            var e = 0;
            if (s.settings.moveSlides > 0)if (s.settings.infiniteLoop) e = s.children.length / y(); else for (var t = 0, i = 0; t < s.children.length;)++e, t = i + g(), i += s.settings.moveSlides <= g() ? s.settings.moveSlides : g(); else e = Math.ceil(s.children.length / g());
            return e
        }, y = function () {
            ...
            if (s.children.length > s.settings.maxSlides && s.active.last && !s.settings.infiniteLoop) {
                if ("horizontal" == s.settings.mode) {
                    var e = s.children.last(), t = e.position();
                    w(-(t.left - (s.viewport.width() - e.width())), "reset", 0)
                } else if ("vertical" == s.settings.mode) {
                    var i = s.children.length - s.settings.minSlides, t = s.children.eq(i).position();
                    w(-t.top, "reset", 0)
                }
            } else {
            ...
            var t = 0;
            if ("next" == s.settings.autoDirection) a.append(s.children.clone().addClass("bx-clone")); else {
            ...
            w(t, "reset", 0), s.settings.pager = !1, s.settings.controls = !1, s.settings.autoControls = !1, s.settings.tickerHover && !s.usingCSS && s.viewport.hover(function () {
                ...
                var i = s.settings.speed / t, n = "horizontal" == s.settings.mode ? "left" : "top", o = i * (t - Math.abs(parseInt(a.css(n))));
                B(o)
            }), B()
        }, B = function (e) {
            ...
            var n = "horizontal" == s.settings.mode ? -t.left : -t.top, o = "horizontal" == s.settings.mode ? -i.left : -i.top, r = {resetValue: o};
            w(n, "ticker", speed, r)
        }, W = function () {
            s.touch = {start: {x: 0, y: 0}, end: {x: 0, y: 0}}, s.viewport.bind("touchstart", O)
        }, O = function (e) {
            if (s.working) e.preventDefault(); else {
            ...
            var t = e.originalEvent, i = Math.abs(t.changedTouches[0].pageX - s.touch.start.x), n = Math.abs(t.changedTouches[0].pageY - s.touch.start.y);
        ...
        return a.goToSlide = function (t, i) {
            if (!s.working && s.active.index != t)if (s.working = !0, s.oldIndex = s.active.index, s.active.index = 0 > t ? v() - 1 : t >= v() ? 0 : t, s.settings.onSlideBefore(s.children.eq(s.active.index), s.oldIndex, s.active.index), "next" == i ? s.settings.onSlideNext(s.children.eq(s.active.index), s.oldIndex, s.active.index) : "prev" == i && s.settings.onSlidePrev(s.children.eq(s.active.index), s.oldIndex, s.active.index), s.active.last = s.active.index >= v() - 1, s.settings.pager && P(s.active.index), s.settings.controls && A(), "fade" == s.settings.mode) s.settings.adaptiveHeight && s.viewport.height() != p() && s.viewport.animate({height: p()}, s.settings.adaptiveHeightSpeed), s.children.filter(":visible").fadeOut(s.settings.speed).css({zIndex: 0}), s.children.eq(s.active.index).css("zIndex", s.settings.slideZIndex + 1).fadeIn(s.settings.speed, function () {
                ...
                if (!s.settings.infiniteLoop && s.carousel && s.active.last)if ("horizontal" == s.settings.mode) {
                    ...
                    var d = 1 == s.settings.moveSlides ? s.settings.maxSlides - y() : (v() - 1) * y() - (s.children.length - s.settings.maxSlides), r = a.children(".bx-clone").eq(d);
                    o = r.position()
                } else if ("next" == i && 0 == s.active.index) o = a.find("> .bx-clone").eq(s.settings.maxSlides).position(), s.active.last = !1; else if (t >= 0) {
                    var c = t * y();
    ...
    function t(t) {
        var a = t || window.event, r = l.call(arguments, 1), d = 0, u = 0, h = 0, p = 0, m = 0, f = 0;
    ...
    var o, s, a = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], r = "onwheel" in document || document.documentMode >= 9 ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], l = Array.prototype.slice;
    ...
    !function (t) {
        var i = "function" == typeof define && define.amd, n = "undefined" != typeof module && module.exports, o = "https:" == document.location.protocol ? "https:" : "http:", s = "cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.12/jquery.mousewheel.min.js";
        ...
        var t, i = "mCustomScrollbar", n = "mCS", o = ".mCustomScrollbar", s = {
        ...
        }, a = 0, r = {}, l = window.attachEvent && !window.addEventListener ? 1 : 0, d = !1, c = ["mCSB_dragger_onDrag", "mCSB_scrollTools_onDrag", "mCS_img_loaded", "mCS_disabled", "mCS_destroyed", "mCS_no_scrollbar", "mCS-autoHide", "mCS-dir-rtl", "mCS_no_scrollbar_y", "mCS_no_scrollbar_x", "mCS_y_hidden", "mCS_x_hidden", "mCSB_draggerContainer", "mCSB_buttonUp", "mCSB_buttonDown", "mCSB_buttonLeft", "mCSB_buttonRight"], u = {
            init: function (t) {
                var t = e.extend(!0, {}, s, t), i = h.call(this);
                if (t.live) {
                    var l = t.liveSelector || this.selector || o, d = e(l);
                ...
                return t.setWidth = t.set_width ? t.set_width : t.setWidth, t.setHeight = t.set_height ? t.set_height : t.setHeight, t.axis = t.horizontalScroll ? "x" : f(t.axis), t.scrollInertia = t.scrollInertia > 0 && t.scrollInertia < 17 ? 17 : t.scrollInertia, "object" != typeof t.mouseWheel && 1 == t.mouseWheel && (t.mouseWheel = {
                    ...
                    if (!i.data(n)) {
                        ...
                        var o = i.data(n), s = o.opt, r = i.data("mcs-axis"), l = i.data("mcs-scrollbar-position"), d = i.data("mcs-theme");
                ...
                return e(o).each(function () {
                    var t = e(this);
                    if (t.data(n)) {
                        var o = t.data(n), s = o.opt, a = e("#mCSB_" + o.idx + "_container"), r = e("#mCSB_" + o.idx), l = [e("#mCSB_" + o.idx + "_dragger_vertical"), e("#mCSB_" + o.idx + "_dragger_horizontal")];
                        if (!a.length)return;
                    ...
                    return e(o).each(function () {
                        ...
                        if (o.data(n)) {
                            var s = o.data(n), a = s.opt, r = {
                                ...
                                onUpdate: !0,
                                onComplete: !0
                            }, l = e.extend(!0, {}, r, i), d = N.call(this, t), c = l.scrollInertia > 0 && l.scrollInertia < 17 ? 17 : l.scrollInertia;
                ...
                return e(t).each(function () {
                    var o = e(this);
                    if (o.data(n)) {
                        var s = o.data(n), a = s.opt, r = e("#mCSB_" + s.idx), l = e("#mCSB_" + s.idx + "_container"), d = e(".mCSB_" + s.idx + "_scrollbar");
            ...
            var i = ["rounded", "rounded-dark", "rounded-dots", "rounded-dots-dark"], n = ["rounded-dots", "rounded-dots-dark", "3d", "3d-dark", "3d-thick", "3d-thick-dark", "inset", "inset-dark", "inset-2", "inset-2-dark", "inset-3", "inset-3-dark"], o = ["minimal", "minimal-dark"], s = ["minimal", "minimal-dark"], a = ["minimal", "minimal-dark"];
            ...
            var m = e("#mCSB_" + o.idx), f = e("#mCSB_" + o.idx + "_container");
            ...
            var t = e(this), i = t.data(n), o = i.opt, s = e("#mCSB_" + i.idx + "_container");
            ...
            var t = e(this), i = t.data(n), o = i.opt, s = e(".mCSB_" + i.idx + "_scrollbar:first"), a = ee(o.scrollButtons.tabindex) ? "tabindex='" + o.scrollButtons.tabindex + "'" : "", r = ["<a href='#' class='" + c[13] + "' oncontextmenu='return false;' " + a + " />", "<a href='#' class='" + c[14] + "' oncontextmenu='return false;' " + a + " />", "<a href='#' class='" + c[15] + "' oncontextmenu='return false;' " + a + " />", "<a href='#' class='" + c[16] + "' oncontextmenu='return false;' " + a + " />"], l = ["x" === o.axis ? r[2] : r[0], "x" === o.axis ? r[3] : r[1], r[2], r[3]];
            o.scrollButtons.enable && s.prepend(l[0]).append(l[1]).next(".mCSB_scrollTools").prepend(l[2]).append(l[3])
        }, x = function () {
            var t = e(this), i = t.data(n), o = e("#mCSB_" + i.idx), s = e("#mCSB_" + i.idx + "_container"), a = [e("#mCSB_" + i.idx + "_dragger_vertical"), e("#mCSB_" + i.idx + "_dragger_horizontal")], r = [o.height() / s.outerHeight(!1), o.width() / s.outerWidth(!1)], d = [parseInt(a[0].css("min-height")), Math.round(r[0] * a[0].parent().height()), parseInt(a[1].css("min-width")), Math.round(r[1] * a[1].parent().width())], c = l && d[1] < d[0] ? d[0] : d[1], u = l && d[3] < d[2] ? d[2] : d[3];
            a[0].css({
                height: c,
                "max-height": a[0].parent().height() - 10
            }).find(".mCSB_dragger_bar").css({"line-height": d[0] + "px"}), a[1].css({
                width: u,
                "max-width": a[1].parent().width() - 10
            })
        }, S = function () {
            var t = e(this), i = t.data(n), o = e("#mCSB_" + i.idx), s = e("#mCSB_" + i.idx + "_container"), a = [e("#mCSB_" + i.idx + "_dragger_vertical"), e("#mCSB_" + i.idx + "_dragger_horizontal")], r = [s.outerHeight(!1) - o.height(), s.outerWidth(!1) - o.width()], l = [r[0] / (a[0].parent().height() - a[0].height()), r[1] / (a[1].parent().width() - a[1].width())];
            i.scrollRatio = {y: l[0], x: l[1]}
        }, C = function (e, t, i) {
            var n = i ? c[0] + "_expanded" : "", o = e.closest(".mCSB_scrollTools");
            ...
            var t = e(this), i = t.data(n), o = e("#mCSB_" + i.idx), s = e("#mCSB_" + i.idx + "_container"), a = null == i.overflowed ? s.height() : s.outerHeight(!1), r = null == i.overflowed ? s.width() : s.outerWidth(!1), l = s[0].scrollHeight, d = s[0].scrollWidth;
            return l > a && (a = l), d > r && (r = d), [a > o.height(), r > o.width()]
        }, k = function () {
            var t = e(this), i = t.data(n), o = i.opt, s = e("#mCSB_" + i.idx), a = e("#mCSB_" + i.idx + "_container"), r = [e("#mCSB_" + i.idx + "_dragger_vertical"), e("#mCSB_" + i.idx + "_dragger_horizontal")];
            ...
            var i = e(this), o = i.data(n), s = o.opt;
            if (!o.bindEvents) {
            ...
            var t = e(this), i = t.data(n), o = i.opt, s = n + "_" + i.idx, a = ".mCSB_" + i.idx + "_scrollbar", r = e("#mCSB_" + i.idx + ",#mCSB_" + i.idx + "_container,#mCSB_" + i.idx + "_container_wrapper," + a + " ." + c[12] + ",#mCSB_" + i.idx + "_dragger_vertical,#mCSB_" + i.idx + "_dragger_horizontal," + a + ">a"), l = e("#mCSB_" + i.idx + "_container");
            ...
            var i = e(this), o = i.data(n), s = o.opt, a = e("#mCSB_" + o.idx + "_container_wrapper"), r = a.length ? a : e("#mCSB_" + o.idx + "_container"), l = [e("#mCSB_" + o.idx + "_scrollbar_vertical"), e("#mCSB_" + o.idx + "_scrollbar_horizontal")], d = [l[0].find(".mCSB_dragger"), l[1].find(".mCSB_dragger")];
            ...
            switch (t) {
                ...
                case"touchmove":
                case"touchend":
                    var i = e.originalEvent.touches[0] || e.originalEvent.changedTouches[0], n = e.originalEvent.touches.length || e.originalEvent.changedTouches.length;
            ...
            function i(e, t, i, n) {
                if (m[0].idleTimer = u.scrollInertia < 233 ? 250 : 0, o.attr("id") === p[1])var s = "x", a = (o[0].offsetLeft - t + n) * c.scrollRatio.x; else var s = "y", a = (o[0].offsetTop - e + i) * c.scrollRatio.y;
                Y(r, a.toString(), {dir: s, drag: !0})
            }

            var o, s, a, r = e(this), c = r.data(n), u = c.opt, h = n + "_" + c.idx, p = ["mCSB_" + c.idx + "_dragger_vertical", "mCSB_" + c.idx + "_dragger_horizontal"], m = e("#mCSB_" + c.idx + "_container"), f = e("#" + p[0] + ",#" + p[1]), g = u.advanced.releaseDraggableSelectors ? f.add(e(u.advanced.releaseDraggableSelectors)) : f;
            f.bind("mousedown." + h + " touchstart." + h + " pointerdown." + h + " MSPointerDown." + h, function (i) {
                if (i.stopImmediatePropagation(), i.preventDefault(), K(i)) {
                    ...
                    var n = o.offset(), c = I(i)[0] - n.top, h = I(i)[1] - n.left, p = o.height() + n.top, m = o.width() + n.left;
                    p > c && c > 0 && m > h && h > 0 && (s = c, a = h), C(o, "active", u.autoExpandScrollbar)
                }
            }).bind("touchmove." + h, function (e) {
                e.stopImmediatePropagation(), e.preventDefault();
                var t = o.offset(), n = I(e)[0] - t.top, r = I(e)[1] - t.left;
                i(s, a, n, r)
            ...
            function o(e) {
                if (J(e) && !d && !I(e)[2] && (e.stopImmediatePropagation(), (!C || S) && c)) {
                    g = Q();
                    var t = E.offset(), i = I(e)[0] - t.top, n = I(e)[1] - t.left, o = "mcsLinearOut";
                    if (F.push(i), L.push(n), B[2] = Math.abs(I(e)[0] - B[0]), B[3] = Math.abs(I(e)[1] - B[1]), k.overflowed[0])var s = P[0].parent().height() - P[0].height(), a = u - i > 0 && i - u > -(s * k.scrollRatio.y) && (2 * B[3] < B[2] || "yx" === j.axis);
                    if (k.overflowed[1])var r = P[1].parent().width() - P[1].width(), p = h - n > 0 && n - h > -(r * k.scrollRatio.x) && (2 * B[2] < B[3] || "yx" === j.axis);
            ...
            function a(e) {
                if (J(e) && !d && !I(e)[2]) {
                    ...
                    var t = E.offset(), i = I(e)[0] - t.top, n = I(e)[1] - t.left;
                    if (!(v - g > 30)) {
                        b = 1e3 / (v - f);
                        var o = "mcsEaseOut", s = 2.5 > b, a = s ? [F[F.length - 2], L[L.length - 2]] : [0, 0];
            ...
            function l(e, t, i, n, o, s) {
                e && Y(T, e.toString(), {dur: t, scrollEasing: i, dir: n, overwrite: o, drag: s})
            }
            ...
            var s, a = e(this), r = a.data(n), l = r.opt, c = r.sequential, u = n + "_" + r.idx, h = e("#mCSB_" + r.idx + "_container"), p = h.parent();
            h.bind("mousedown." + u, function (e) {
                t || s || (s = 1, d = !0)
            }).add(document).bind("mousemove." + u, function (e) {
                if (!t && s && i()) {
                    var n = h.offset(), a = I(e)[0] - n.top + h[0].offsetTop, d = I(e)[1] - n.left + h[0].offsetLeft;
            ...
            function t(t, n) {
                if (q(i), !D(i, t.target)) {
                    ...
                    if ("x" === s.axis || "x" === s.mouseWheel.axis)var c = "x", u = [Math.round(a * o.scrollRatio.x), parseInt(s.mouseWheel.scrollAmount)], h = "auto" !== s.mouseWheel.scrollAmount ? u[1] : u[0] >= r.width() ? .9 * r.width() : u[0], p = Math.abs(e("#mCSB_" + o.idx + "_container")[0].offsetLeft), m = d[1][0].offsetLeft, f = d[1].parent().width() - d[1].width(), g = t.deltaX || t.deltaY || n; else var c = "y", u = [Math.round(a * o.scrollRatio.y), parseInt(s.mouseWheel.scrollAmount)], h = "auto" !== s.mouseWheel.scrollAmount ? u[1] : u[0] >= r.height() ? .9 * r.height() : u[0], p = Math.abs(e("#mCSB_" + o.idx + "_container")[0].offsetTop), m = d[0][0].offsetTop, f = d[0].parent().height() - d[0].height(), g = t.deltaY || n;
                    "y" === c && !o.overflowed[0] || "x" === c && !o.overflowed[1] || ((s.mouseWheel.invert || t.webkitDirectionInvertedFromDevice) && (g = -g), s.mouseWheel.normalizeDelta && (g = 0 > g ? -1 : 1), (g > 0 && 0 !== m || 0 > g && m !== f || s.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()), Y(i, (p - g * h).toString(), {dir: c}))
                }
            }

            if (e(this).data(n)) {
                var i = e(this), o = i.data(n), s = o.opt, a = n + "_" + o.idx, r = e("#mCSB_" + o.idx), d = [e("#mCSB_" + o.idx + "_dragger_vertical"), e("#mCSB_" + o.idx + "_dragger_horizontal")], c = e("#mCSB_" + o.idx + "_container").find("iframe");
            ...
            var t = e(this), i = t.data(n), o = n + "_" + i.idx, s = e("#mCSB_" + i.idx + "_container"), a = s.parent(), r = e(".mCSB_" + i.idx + "_scrollbar ." + c[12]);
            r.bind("touchstart." + o + " pointerdown." + o + " MSPointerDown." + o, function (e) {
                ...
                if (e(n.target).hasClass(c[12]) || e(n.target).hasClass("mCSB_draggerRail")) {
                    q(t);
                    var o = e(this), r = o.find(".mCSB_dragger");
                    if (o.parent(".mCSB_scrollTools_horizontal").length > 0) {
                        if (!i.overflowed[1])return;
                        var l = "x", d = n.pageX > r.offset().left ? -1 : 1, u = Math.abs(s[0].offsetLeft) - .9 * d * a.width()
                    } else {
                        if (!i.overflowed[0])return;
                        var l = "y", d = n.pageY > r.offset().top ? -1 : 1, u = Math.abs(s[0].offsetTop) - .9 * d * a.height()
                    }
                    Y(t, u.toString(), {dir: l, scrollEasing: "mcsEaseInOut"})
                }
            })
        }, B = function () {
            var t = e(this), i = t.data(n), o = i.opt, s = n + "_" + i.idx, a = e("#mCSB_" + i.idx + "_container"), r = a.parent();
            a.bind("focusin." + s, function (i) {
                ...
                n.is(o.advanced.autoScrollOnFocus) && (q(t), clearTimeout(t[0]._focusTimeout), t[0]._focusTimer = s ? (l + 17) * s : 0, t[0]._focusTimeout = setTimeout(function () {
                    var e = [te(n)[0], te(n)[1]], i = [a[0].offsetTop, a[0].offsetLeft], s = [i[0] + e[0] >= 0 && i[0] + e[0] < r.height() - n.outerHeight(!1), i[1] + e[1] >= 0 && i[0] + e[1] < r.width() - n.outerWidth(!1)], d = "yx" !== o.axis || s[0] || s[1] ? "all" : "none";
            ...
            var t = e(this), i = t.data(n), o = n + "_" + i.idx, s = e("#mCSB_" + i.idx + "_container").parent();
            s.bind("scroll." + o, function (t) {
                (0 !== s.scrollTop() || 0 !== s.scrollLeft()) && e(".mCSB_" + i.idx + "_scrollbar").css("visibility", "hidden")
            })
        }, O = function () {
            var t = e(this), i = t.data(n), o = i.opt, s = i.sequential, a = n + "_" + i.idx, r = ".mCSB_" + i.idx + "_scrollbar", l = e(r + ">a");
            ...
            function t(t) {
                ...
                switch (t.type) {
                    ...
                    case"keydown":
                    case"keyup":
                        var r = t.keyCode ? t.keyCode : t.which, l = "on";
                        if ("x" !== s.axis && (38 === r || 40 === r) || "y" !== s.axis && (37 === r || 39 === r)) {
                            ...
                            if ((o.overflowed[0] || o.overflowed[1]) && (t.preventDefault(), t.stopImmediatePropagation()), "keyup" === t.type) {
                                q(i);
                                var h = 34 === r ? -1 : 1;
                                if ("x" === s.axis || "yx" === s.axis && o.overflowed[1] && !o.overflowed[0])var p = "x", m = Math.abs(d[0].offsetLeft) - .9 * h * c.width(); else var p = "y", m = Math.abs(d[0].offsetTop) - .9 * h * c.height();
                                Y(i, m.toString(), {dir: p, scrollEasing: "mcsEaseInOut"})
                            }
                            ...
                            if ("x" === s.axis || "yx" === s.axis && o.overflowed[1] && !o.overflowed[0])var p = "x", m = 35 === r ? Math.abs(c.width() - d.outerWidth(!1)) : 0; else var p = "y", m = 35 === r ? Math.abs(c.height() - d.outerHeight(!1)) : 0;
                            Y(i, m.toString(), {dir: p, scrollEasing: "mcsEaseInOut"})
                        }
                }
            }

            var i = e(this), o = i.data(n), s = o.opt, a = o.sequential, r = n + "_" + o.idx, l = e("#mCSB_" + o.idx), d = e("#mCSB_" + o.idx + "_container"), c = d.parent(), u = "input,textarea,select,datalist,keygen,[contenteditable='true']", h = d.find("iframe"), p = ["blur." + r + " keydown." + r + " keyup." + r];
            ...
            var d = t.data(n), u = d.opt, h = d.sequential, p = e("#mCSB_" + d.idx + "_container"), m = "stepped" === h.type ? !0 : !1, f = u.scrollInertia < 26 ? 26 : u.scrollInertia, g = u.scrollInertia < 1 ? 17 : u.scrollInertia;
            switch (i) {
                case"on":
            ...
            if (null != t && "undefined" != typeof t) {
                var o = e(this), s = o.data(n), a = s.opt, r = e("#mCSB_" + s.idx + "_container"), l = r.parent(), d = typeof t;
                i || (i = "x" === a.axis ? "x" : "y");
                var c = "x" === i ? r.outerWidth(!1) : r.outerHeight(!1), h = "x" === i ? r[0].offsetLeft : r[0].offsetTop, p = "x" === i ? "left" : "top";
                switch (d) {
                    case"function":
                        return t();
                    case"object":
            ...
            function s() {
                ...
                var e = 0, t = h.find(d.advanced.updateOnSelectorChange);
            ...
            var r = e(this), l = r.data(n), d = l.opt, h = e("#mCSB_" + l.idx + "_container");
            return t ? (clearTimeout(h[0].autoUpdate), void G(h[0], "autoUpdate")) : void i()
        }, U = function (e, t, i) {
            return Math.round(e / t) * t - i
        }, q = function (t) {
            var i = t.data(n), o = e("#mCSB_" + i.idx + "_container,#mCSB_" + i.idx + "_container_wrapper,#mCSB_" + i.idx + "_dragger_vertical,#mCSB_" + i.idx + "_dragger_horizontal");
            o.each(function () {
                Z.call(this)
            })
        }, Y = function (t, i, o) {
            ...
            function r() {
                var e = [p[0].offsetTop, p[0].offsetLeft], i = [v[0].offsetTop, v[0].offsetLeft], n = [p.outerHeight(!1), p.outerWidth(!1)], s = [h.height(), h.width()];
                t[0].mcs = {
                    content: p,
                    top: e[0],
                    left: e[1],
            ...
            var l = t.data(n), d = l.opt, c = {
                ...
                onUpdate: !0,
                onComplete: !0
            }, o = e.extend(c, o), u = [o.dur, o.drag ? 0 : o.dur], h = e("#mCSB_" + l.idx), p = e("#mCSB_" + l.idx + "_container"), m = p.parent(), f = d.callbacks.onTotalScrollOffset ? N.call(t, d.callbacks.onTotalScrollOffset) : [0, 0], g = d.callbacks.onTotalScrollBackOffset ? N.call(t, d.callbacks.onTotalScrollBackOffset) : [0, 0];
            if (l.trigger = o.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + l.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== i || l.contentReset.y || (s("onOverflowYNone") && d.callbacks.onOverflowYNone.call(t[0]), l.contentReset.y = 1), "_resetX" !== i || l.contentReset.x || (s("onOverflowXNone") && d.callbacks.onOverflowXNone.call(t[0]), l.contentReset.x = 1), "_resetY" !== i && "_resetX" !== i) {
                switch (!l.contentReset.y && t[0].mcs || !l.overflowed[0] || (s("onOverflowY") && d.callbacks.onOverflowY.call(t[0]), l.contentReset.x = null), !l.contentReset.x && t[0].mcs || !l.overflowed[1] || (s("onOverflowX") && d.callbacks.onOverflowX.call(t[0]), l.contentReset.x = null), d.snapAmount && (i = U(i, d.snapAmount, d.snapOffset)), o.dir) {
                    case"x":
                        var v = e("#mCSB_" + l.idx + "_dragger_horizontal"), y = "left", b = p[0].offsetLeft, w = [h.width() - p.outerWidth(!1), v.parent().width() - v.width()], x = [i, 0 === i ? 0 : i / l.scrollRatio.x], S = f[1], T = g[1], k = S > 0 ? S / l.scrollRatio.x : 0, j = T > 0 ? T / l.scrollRatio.x : 0;
                        break;
                    case"y":
                        var v = e("#mCSB_" + l.idx + "_dragger_vertical"), y = "top", b = p[0].offsetTop, w = [h.height() - p.outerHeight(!1), v.parent().height() - v.height()], x = [i, 0 === i ? 0 : i / l.scrollRatio.y], S = f[0], T = g[0], k = S > 0 ? S / l.scrollRatio.y : 0, j = T > 0 ? T / l.scrollRatio.y : 0
                }
            ...
            var h, p, a = a || {}, m = a.onStart || function () {
                }, f = a.onUpdate || function () {
                }, g = a.onComplete || function () {
                }, v = Q(), y = 0, b = e.offsetTop, w = e.style, x = e._mTween[t];
...
mejs.version = "2.18.2", mejs.meIndex = 0, mejs.plugins = {
    ...
    encodeUrl: function (e) {
        ...
        for (var t, i, n, o, s, a, r = 0, l = "", d = "", c = document.getElementsByTagName("script"), u = c.length, h = e.length; u > r; r++) {
            for (o = c[r].src, i = o.lastIndexOf("/"), i > -1 ? (a = o.substring(i + 1), s = o.substring(0, i + 1)) : (a = o, s = ""), t = 0; h > t; t++)if (d = e[t], n = a.indexOf(d), n > -1) {
                l = s;
                break
            }
            if ("" !== l)break
        ...
        var n = t.timeFormat, o = n[0], s = n[1] == n[0], a = s ? 2 : 1, r = ":", l = Math.floor(e / 3600) % 24, d = Math.floor(e / 60) % 60, c = Math.floor(e % 60), u = Math.floor((e % 1 * i).toFixed(3)), h = [[u, "f"], [c, "s"], [d, "m"], [l, "h"]];
        n.length < a && (r = n[a]);
        for (var p = !1, m = 0, f = h.length; f > m; m++)if (-1 !== n.indexOf(h[m][1])) p = !0; else if (p) {
            for (var g = !1, v = m; f > v; v++)if (h[v][0] > 0) {
                g = !0;
                break
            }
            if (!g)break;
        ...
        var n = t.currentTimeFormat, s = Math.floor(e / 3600) % 24, a = Math.floor(e / 60) % 60, r = Math.floor(e % 60), l = Math.floor((e % 1 * o).toFixed(3));
        lis = [[l, "f"], [r, "s"], [a, "m"], [s, "h"]];
        var d = n;
        ...
        var o = e.split(":"), s = parseInt(o[0], 10), a = parseInt(o[1], 10), r = parseInt(o[2], 10), l = 0, d = 0;
    ...
    detectPlugin: function (e, t, i, n) {
        ...
        if ("undefined" != typeof this.nav.plugins && "object" == typeof this.nav.plugins[e]) {
            if (o = this.nav.plugins[e].description, o && ("undefined" == typeof this.nav.mimeTypes || !this.nav.mimeTypes[t] || this.nav.mimeTypes[t].enabledPlugin))for (r = o.replace(e, "").replace(/^\s+/, "").replace(/\sr/gi, ".").split("."), s = 0; s < r.length; s++)r[s] = parseInt(r[s].match(/\d+/), 10)
    ...
    init: function () {
        var e, t, i = this, n = document, o = mejs.PluginDetector.nav, s = mejs.PluginDetector.ua.toLowerCase(), a = ["source", "track", "audio", "video"];
    ...
    canPlayType: function (e) {
        ...
        for (t = 0; t < o.length; t++)if (n = o[t], mejs.PluginDetector.hasPluginVersion(this.pluginType, n.version))for (i = 0; i < n.types.length; i++)if (e == n.types[i])return "probably";
        return ""
    },
    ...
    removeEventListener: function (e, t) {
        ...
        for (var n = 0; n < i.length; n++)if (i[n] === t)return this.events[e].splice(n, 1), !0;
        return !1
    },
    ...
    pluginMediaElements: {}, htmlMediaElements: {}, registerPluginElement: function (e, t, i) {
    ...
    create: function (e, t) {
        ...
        if ("undefined" != typeof t.type && "" !== t.type)if ("string" == typeof t.type) g.push({
            ...
            type: c,
            url: o
        }); else for (s = 0; s < e.childNodes.length; s++)d = e.childNodes[s], 1 == d.nodeType && "source" == d.tagName.toLowerCase() && (o = d.getAttribute("src"), c = this.formatType(o, d.getAttribute("type")), f = d.getAttribute("media"), (!f || !window.matchMedia || window.matchMedia && window.matchMedia(f).matches) && g.push({
            type: c,
            url: o
        }));
        if (!n && g.length > 0 && null !== g[0].url && this.getTypeFromFile(g[0].url).indexOf("audio") > -1 && (v.isVideo = !1), mejs.MediaFeatures.isBustedAndroid && (e.canPlayType = function (e) {
            ...
            for (n || (m = document.createElement(v.isVideo ? "video" : "audio"), e.parentNode.insertBefore(m, e), e.style.display = "none", v.htmlMediaElement = e = m), s = 0; s < g.length; s++)if ("video/m3u8" == g[s].type || "" !== e.canPlayType(g[s].type).replace(/no/, "") || "" !== e.canPlayType(g[s].type.replace(/mp3/, "mpeg")).replace(/no/, "") || "" !== e.canPlayType(g[s].type.replace(/m4a/, "mp4")).replace(/no/, "")) {
                v.method = "native", v.url = g[s].url;
                break
            }
            if ("native" === v.method && (null !== v.url && (e.src = v.url), "auto_plugin" !== t.mode))return v
        }
        if ("auto" === t.mode || "auto_plugin" === t.mode || "shim" === t.mode)for (s = 0; s < g.length; s++)for (c = g[s].type, a = 0; a < t.plugins.length; a++)for (u = t.plugins[a], h = mejs.plugins[u], r = 0; r < h.length; r++)if (p = h[r], null == p.version || mejs.PluginDetector.hasPluginVersion(u, p.version))for (l = 0; l < p.types.length; l++)if (c.toLowerCase() == p.types[l].toLowerCase())return v.method = u, v.url = g[s].url, v;
        ...
        var n = e.htmlMediaElement, o = document.createElement("div"), s = t.customError;
        ...
        var a, r, l, d = e.htmlMediaElement, c = 1, u = 1, h = "me_" + e.method + "_" + mejs.meIndex++, p = new mejs.PluginMediaElement(h, e.method, e.url), m = document.createElement("div");
        p.tagName = d.tagName;
    ...
    "use strict";
    var n = {
        locale: {language: t.i18n && t.i18n.locale.language || "", strings: t.i18n && t.i18n.locale.strings || {}},
    ...
    mejs.MepDefaults = {
        ...
        hasFocus: !1, controlsAreVisible: !0, init: function () {
            ...
            if (t.isDynamic = "audio" !== o && "video" !== o, t.isDynamic ? t.isVideo = t.options.isVideo : t.isVideo = "audio" !== o && t.options.isVideo, i.isiPad && t.options.iPadUseNativeControls || i.isiPhone && t.options.iPhoneUseNativeControls) t.$media.attr("controls", "controls"), i.isiPad && null !== t.media.getAttribute("autoplay") && t.play(); else if (i.isAndroid && t.options.AndroidUseNativeControls); else {
                ...
                var r = t.isVideo ? "video" : "audio", l = r.substring(0, 1).toUpperCase() + r.substring(1);
            ...
            var n, o, s = this, a = mejs.MediaFeatures, r = i.getAttribute("autoplay"), l = !("undefined" == typeof r || null === r || "false" === r);
            if (!s.created) {
                if (s.created = !0, s.media = t, s.domNode = i, !(a.isAndroid && s.options.AndroidUseNativeControls || a.isiPad && s.options.iPadUseNativeControls || a.isiPhone && s.options.iPhoneUseNativeControls)) {
                    ...
                    for (n in s.options.features)if (o = s.options.features[n], s["build" + o])try {
            ...
            if ("undefined" != typeof t && (n.width = t), "undefined" != typeof i && (n.height = i), n.height.toString().indexOf("%") > 0 || "none" !== n.$node.css("max-width") && "t.width" !== n.$node.css("max-width") || n.$node[0].currentStyle && "100%" === n.$node[0].currentStyle.maxWidth) {
                ...
                }(), a = n.container.parent().closest(":visible").width(), r = n.container.parent().closest(":visible").height(), l = n.isVideo || !n.options.autosizeProgress ? parseInt(a * s / o, 10) : s;
            ...
            var t = this, i = 0, n = 0, o = t.controls.find(".mejs-time-rail"), s = t.controls.find(".mejs-time-total"), a = o.siblings(), r = a.last(), l = null;
            ...
            var s = this, a = e('<div class="mejs-poster mejs-layer"></div>').appendTo(n), r = t.$media.attr("poster");
            ...
            var i = this, n = i.container.find(".mejs-poster"), o = n.find("img");
            0 === o.length && (o = e('<img width="100%" height="100%" alt="" />').appendTo(n)), o.attr("src", t), n.css({"background-image": "url(" + t + ")"})
        }, buildoverlays: function (t, i, n, o) {
            var s = this;
            if (t.isVideo) {
                var a = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-loading"><span></span></div></div>').hide().appendTo(n), r = e('<div class="mejs-overlay mejs-layer"><div class="mejs-overlay-error"></div></div>').hide().appendTo(n), l = e('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(n).bind("click", function () {
            ...
            if (e.hasFocus && e.options.enableKeyboard)for (var n = 0, o = e.options.keyActions.length; o > n; n++)for (var s = e.options.keyActions[n], a = 0, r = s.keys.length; r > a; a++)if (i.keyCode == s.keys[a])return "function" == typeof i.preventDefault && i.preventDefault(), s.action(e, t, i.keyCode), !1;
            return !0
        }, findTracks: function () {
        ...
        mejs.MediaElementPlayer.prototype.globalBind = function (i, n, o) {
            var s = this, a = s.node ? s.node.ownerDocument : document;
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildplaypause: function (t, i, n, o) {
            ...
            var a = this, r = a.options, l = e('<div class="mejs-button mejs-playpause-button mejs-play" ><button type="button" aria-controls="' + a.id + '" title="' + r.playText + '" aria-label="' + r.playText + '"></button></div>').appendTo(i).click(function (e) {
    ...
    e.extend(mejs.MepDefaults, {progessHelpText: mejs.i18n.t("Use Left/Right Arrow keys to advance one second, Up/Down arrows to advance ten seconds.")}), e.extend(MediaElementPlayer.prototype, {
        buildprogress: function (t, i, n, o) {
            ...
            var s = this, a = i.find(".mejs-time-total"), r = i.find(".mejs-time-loaded"), l = i.find(".mejs-time-current"), d = i.find(".mejs-time-handle"), c = i.find(".mejs-time-float"), u = i.find(".mejs-time-float-current"), h = i.find(".mejs-time-slider"), p = function (e) {
                var i, n = a.offset(), s = a.width(), r = 0, l = 0, d = 0;
            ...
            }, m = !1, f = !1, g = 0, v = !1, y = t.options.autoRewind, b = function (e) {
                var i = o.currentTime, n = mejs.i18n.t("Time Slider"), s = mejs.Utility.secondsToTimeCode(i, t.options), a = o.duration;
                h.attr({
                    "aria-label": n,
                    "aria-valuemin": 0,
                    "aria-valuemax": a,
            ...
            h.bind("focus", function (e) {
                ...
                var t = e.keyCode, i = o.duration, n = o.currentTime;
                switch (t) {
                    case 37:
                        n -= 1;
                        break;
        ...
        buildvolume: function (t, i, n, o) {
            if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                var s = this, a = s.isVideo ? s.options.videoVolume : s.options.audioVolume, r = "horizontal" == a ? e('<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' + s.id + '" title="' + s.options.muteText + '" aria-label="' + s.options.muteText + '"></button></div><a href="javascript:void(0);" class="mejs-horizontal-volume-slider"><span class="mejs-offscreen">' + s.options.allyVolumeControlText + '</span><div class="mejs-horizontal-volume-total"></div><div class="mejs-horizontal-volume-current"></div><div class="mejs-horizontal-volume-handle"></div></a>').appendTo(i) : e('<div class="mejs-button mejs-volume-button mejs-mute"><button type="button" aria-controls="' + s.id + '" title="' + s.options.muteText + '" aria-label="' + s.options.muteText + '"></button><a href="javascript:void(0);" class="mejs-volume-slider"><span class="mejs-offscreen">' + s.options.allyVolumeControlText + '</span><div class="mejs-volume-total"></div><div class="mejs-volume-current"></div><div class="mejs-volume-handle"></div></a></div>').appendTo(i), l = s.container.find(".mejs-volume-slider, .mejs-horizontal-volume-slider"), d = s.container.find(".mejs-volume-total, .mejs-horizontal-volume-total"), c = s.container.find(".mejs-volume-current, .mejs-horizontal-volume-current"), u = s.container.find(".mejs-volume-handle, .mejs-horizontal-volume-handle"), h = function (e, t) {
                    ...
                    var t = null, i = d.offset();
                    if ("vertical" === a) {
                        var n = d.height(), s = e.pageY - i.top;
                        if (t = (n - s) / n, 0 === i.top || 0 === i.left)return
                    } else {
                        var r = d.width(), l = e.pageX - i.left;
                        t = l / r
                    }
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildfullscreen: function (t, i, n, o) {
            if (t.isVideo) {
                ...
                var a = this, r = e('<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' + a.id + '" title="' + a.options.fullscreenText + '" aria-label="' + a.options.fullscreenText + '"></button></div>').appendTo(i);
                if ("native" === a.media.pluginType || !a.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox) r.click(function () {
                    ...
                    if (d && !mejs.MediaFeatures.isOpera) {
                        ...
                        }, m = {}, f = ["top", "left", "right", "bottom"], g = function () {
                            var e = r.offset().left - a.container.offset().left, t = r.offset().top - a.container.offset().top, i = r.outerWidth(!0), n = r.outerHeight(!0), o = a.container.width(), s = a.container.height();
                            for (c in m)m[c].css({position: "absolute", top: 0, left: 0});
                            m.top.width(o).height(t), m.left.width(e).height(n).css({top: t}), m.right.width(o - e - i).height(n).css({
                                top: t,
                                left: e + i
                            }), m.bottom.width(o).height(s - n - t).css({top: t + n})
                        };
                        ...
                        r.on("mouseover", function () {
                            if (!a.isFullScreen) {
                                var e = r.offset(), i = t.container.offset();
        ...
        enterFullScreen: function () {
            ...
            if ("native" === t.media.pluginType || !mejs.MediaFeatures.isFirefox && !t.options.usePluginFullScreen) {
                if (e(document.documentElement).addClass("mejs-fullscreen"), t.normalHeight = t.container.height(), t.normalWidth = t.container.width(), "native" === t.media.pluginType)if (mejs.MediaFeatures.hasTrueNativeFullScreen) mejs.MediaFeatures.requestFullScreen(t.container[0]), t.isInIframe && setTimeout(function n() {
                    if (t.isNativeFullScreen) {
                        var i = window.devicePixelRatio || 1, o = .002, s = i * e(window).width(), a = screen.width, r = i * s;
                        Math.abs(a - s) > Math.abs(a - r) && (s = r);
                        var l = Math.abs(a - s), d = a * o;
                        l > d ? t.exitFullScreen() : setTimeout(n, 500)
                    }
                }, 1e3); else if (mejs.MediaFeatures.hasSemiNativeFullScreen)return void t.media.webkitEnterFullscreen();
                if (t.isInIframe) {
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildspeed: function (t, i, n, o) {
            ...
            if ("native" == s.media.pluginType) {
                ...
                var f = function (e) {
                    for (h = 0, p = c.length; p > h; h++)if (c[h].value === e)return c[h].name
    ...
    e.extend(mejs.MepDefaults, {
        ...
        hasChapters: !1, cleartracks: function (e, t, i, n) {
            ...
            if (0 !== t.tracks.length) {
                var s, a = this, r = a.options.tracksAriaLive ? 'role="log" aria-live="assertive" aria-atomic="false"' : "";
            ...
            var i = this, n = i.tracks[t], o = function () {
            ...
            if ("undefined" != typeof this.tracks) {
                ...
                if (null !== i && i.isLoaded) {
                    for (e = 0; e < i.entries.times.length; e++)if (t.media.currentTime >= i.entries.times[e].start && t.media.currentTime <= i.entries.times[e].stop)return t.captionsText.html(i.entries.text[e]).attr("class", "mejs-captions-text " + (i.entries.times[e].identifier || "")), void t.captions.show().height(0);
                    t.captions.hide()
            ...
            if ("undefined" != typeof this.tracks && "undefined" != typeof this.slidesContainer) {
                var i = this, n = i.slides.entries.text[t], o = i.slides.entries.imgs[t];
        ...
        webvtt: {
            ...
            parse: function (t) {
                for (var i, n, o, s = 0, a = mejs.TrackFormatParser.split2(t, /\r?\n/), r = {
                    ...
                    if (i = this.pattern_timecode.exec(a[s]), i && s < a.length) {
                        for (s - 1 >= 0 && "" !== a[s - 1] && (o = a[s - 1]), s++, n = a[s], s++; "" !== a[s] && s < a.length;)n = n + "\n" + a[s], s++;
            ...
            parse: function (t) {
                t = e(t).filter("tt");
                var i, n, o = 0, s = t.children("div").eq(0), a = s.find("p"), r = t.find("#" + s.attr("style")), l = {
                    text: [],
                    times: []
                };
                if (r.length) {
                    var d = r.removeAttr("id").get(0).attributes;
                    if (d.length)for (i = {}, o = 0; o < d.length; o++)i[d[o].name.split(":")[1]] = d[o].value
                }
                for (o = 0; o < a.length; o++) {
                    var c, u = {start: null, stop: null, style: null};
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildcontextmenu: function (t, i, n, o) {
            ...
            for (var n = this, o = "", s = n.options.contextMenuItems, a = 0, r = s.length; r > a; a++)if (s[a].isSeparator) o += '<div class="mejs-contextmenu-separator"></div>'; else {
                var l = s[a].render(n);
            ...
            n.contextMenu.empty().append(e(o)).css({
                ...
                var t = e(this), i = parseInt(t.data("itemindex"), 10), o = n.options.contextMenuItems[i];
    ...
    e.extend(mejs.MepDefaults, {
        ...
        buildskipback: function (t, i, n, o) {
            var s = this, a = s.options.skipBackText.replace("%1", s.options.skipBackInterval);
    ...
    e.extend(mejs.MepDefaults, {postrollCloseText: mejs.i18n.t("Close")}), e.extend(MediaElementPlayer.prototype, {
        buildpostroll: function (t, i, n, o) {
            var s = this, a = s.container.find('link[rel="postroll"]').attr("href");
    ...
    }, l = navigator.userAgent.match(/msie/i), d = null, c = t.createTouch !== n, u = function (e) {
    ...
    i.extend(r, {
        ...
        _start: function (e) {
            ...
            if (o = i.extend(!0, {}, r.opts, t), t = o.margin, n = o.padding, "number" === i.type(t) && (o.margin = [t, t, t, t]), "number" === i.type(n) && (o.padding = [n, n, n, n]), o.modal && i.extend(!0, o, {
                ...
                }), o.autoSize && (o.autoWidth = o.autoHeight = !0), "auto" === o.width && (o.autoWidth = !0), "auto" === o.height && (o.autoHeight = !0), o.group = r.group, o.index = e, r.coming = o, !1 === r.trigger("beforeLoad")) r.coming = null; else {
        ...
        _loadIframe: function () {
            var e = r.coming, t = i(e.tpl.iframe.replace(/\{rnd\}/g, (new Date).getTime())).attr("scrolling", c ? "auto" : e.iframe.scrolling).attr("src", e.href);
        ...
        _afterLoad: function () {
            var e, t, n, o, s, a = r.coming, l = r.current;
            if (r.hideLoading(), a && !1 !== r.isActive)if (!1 === r.trigger("afterLoad", a, l)) a.wrap.stop(!0).trigger("onReset").remove(), r.coming = null; else {
        ...
        _setDimension: function () {
            var e, t, n, o, s, a, l, d, c, u = r.getViewport(), h = 0, g = !1, v = !1, g = r.wrap, y = r.skin, b = r.inner, w = r.current, v = w.width, x = w.height, S = w.minWidth, C = w.minHeight, T = w.maxWidth, k = w.maxHeight, j = w.scrolling, _ = w.scrollOutside ? w.scrollbarWidth : 0, E = w.margin, I = m(E[1] + E[3]), M = m(E[0] + E[2]);
            ...
            if (v = m(o), x = m(s), d = o / s, S = m(p(S) ? m(S, "w") - t : S), T = m(p(T) ? m(T, "w") - t : T), C = m(p(C) ? m(C, "h") - n : C), k = m(p(k) ? m(k, "h") - n : k), a = T, l = k, w.fitToView && (T = Math.min(u.w - t, T), k = Math.min(u.h - n, k)), t = u.w - I, M = u.h - M, w.aspectRatio ? (v > T && (v = T, x = m(v / d)), x > k && (x = k, v = m(x * d)), S > v && (v = S, x = m(v / d)), C > x && (x = C, v = m(x * d))) : (v = Math.max(S, Math.min(v, T)), w.autoHeight && "iframe" !== w.type && (b.width(v), x = b.height()), x = Math.max(C, Math.min(x, k))), w.fitToView)if (b.width(v).height(x), g.width(v + E), u = g.width(), I = g.height(), w.aspectRatio)for (; (u > t || I > M) && v > S && x > C && !(19 < h++);)x = Math.max(C, Math.min(k, x - 10)), v = m(x * d), S > v && (v = S, x = m(v / d)), v > T && (v = T, x = m(v / d)), b.width(v).height(x), g.width(v + E), u = g.width(), I = g.height(); else v = Math.max(S, Math.min(v, v - (u - t))), x = Math.max(C, Math.min(x, x - (I - M)));
        ...
        _getPosition: function (e) {
            var t = r.current, i = r.getViewport(), n = t.margin, o = r.wrap.width() + n[1] + n[3], s = r.wrap.height() + n[0] + n[2], n = {
                position: "absolute",
                top: n[0],
                left: n[3]
            };
        ...
        getOrigPosition: function () {
            var e = r.current, t = e.element, i = e.orig, n = {}, o = 50, s = 50, a = e.hPadding, l = e.wPadding, d = r.getViewport();
            ...
            var i, n, o = t.prop;
            n = r.current;
            var s = n.wrapSpace, a = n.skinSpace;
            ...
            var e, t = r.current, i = t.nextEffect, n = t.pos, o = {opacity: 1}, s = r.direction;
        ...
        defaults: {type: "float", position: "bottom"}, beforeShow: function (e) {
            var t = r.current, n = t.title, o = e.type;
    ...
    "use strict";
    var t = e.fancybox, i = function (t, i, n) {
    ...
    t.helpers.media = {
        defaults: {
            ...
            for (o in t)if (t.hasOwnProperty(o) && (s = t[o], a = l.match(s.matcher))) {
    ...
    var n = {
        init: function (t, i) {
            ...
            if (t = e(this.options.responsiveBaseWidth).width(), t > (this.options.itemsDesktop[0] || this.orignalItems) && (this.options.items = this.orignalItems), !1 !== this.options.itemsCustom)for (this.options.itemsCustom.sort(function (e, t) {
                return e[0] - t[0]
            }), i = 0; i < this.options.itemsCustom.length; i += 1)this.options.itemsCustom[i][0] <= t && (this.options.items = this.options.itemsCustom[i][1]); else t <= this.options.itemsDesktop[0] && !1 !== this.options.itemsDesktop && (this.options.items = this.options.itemsDesktop[1]), t <= this.options.itemsDesktopSmall[0] && !1 !== this.options.itemsDesktopSmall && (this.options.items = this.options.itemsDesktopSmall[1]), t <= this.options.itemsTablet[0] && !1 !== this.options.itemsTablet && (this.options.items = this.options.itemsTablet[1]),
            ...
            t.$owlItems.each(function (o) {
                var s = e(this);
                s.css({width: t.itemWidth}).data("owl-item", Number(o)), (0 === o % t.options.items || o === n) && (o > n || (i += 1)), s.data("owl-roundPages", i)
            })
            ...
            for (this.paginationWrapper.html(""), t = 0, i = this.itemsAmount - this.itemsAmount % this.options.items, o = 0; o < this.itemsAmount; o += 1)0 === o % this.options.items && (t += 1, i === o && (n = this.itemsAmount - this.options.items), s = e("<div/>", {"class": "owl-page"}), a = e("<span></span>", {
            ...
            var t = this, i = !0 === t.options.scrollPerPage ? t.pagesInArray : t.positionsInArray, n = t.newPosX, o = null;
            ...
            var o, s = this, a = e(s.$owlItems[s.currentItem]).find("img");
            ...
            var e = this, t = e.outClass, i = e.inClass, n = e.$owlItems.eq(e.currentItem), o = e.$owlItems.eq(e.prevItem), s = Math.abs(e.positionsInArray[e.currentItem]) + e.positionsInArray[e.prevItem], a = Math.abs(e.positionsInArray[e.currentItem]) + e.itemWidth / 2;
    ...
    function i(e) {
        var t = e.closest(".op-btn-group"), i = e.position().left, n = e.outerWidth(), o = t.find(".op-btn-bar-line");
        t.find("button").removeClass("active"), e.addClass("active"), o.css({left: i + "px", width: n})
    }
    ...
    function o() {
        s.css("height", "auto");
        var t = e(window).height(), i = s.height(), n = t - i - r - l;
        if (n > 0) s.css("height", "auto"); else {
            var o = t - r - l;
            s.css("height", o + "px")
        }
    }

    var s = "", a = "", r = 100, l = 20, d = 250, c = d + 2, u = "33d685";
    e(function () {
        n(), o(), e(window).resize(function () {
            o()
        }), a.click(function () {
            e(this).hasClass("opened") ? (e(this).parent().animate({left: "-" + c + "px"}, 500), e(this).removeClass("opened")) : (e(this).parent().animate({left: "0px"}, 500), e(this).addClass("opened"))
    ...
    function a() {
        var t = e(".interests-list"), i = e(".interests-list li span");
        if (t.length > 0)for (var n = 0; n < i.length; n++) {
            var o = e(i[n]).outerWidth(), s = e(i[n]).parent().outerWidth(), a = (s - o) / 2;
            e(i[n]).css("left", a + "px")
        }
    }
    ...
    function c() {
        var t = e(".calendar-busy"), i = t.find(".calendar-thead"), n = t.find(".calendar-tbody"), o = t.find(".calendar-today .day"), s = t.find(".calendar-today .month"), a = t.find(".calendar-today .week-day"), r = t.find(".active-month"), l = t.find(".active-year"), d = r.add(l);
        t.length > 0 && (z = {
            ...
            createMonthHtml: function (e, t) {
                var i = "", o = new Date(e, t, 1).getDay(), s = [];
    ...
    function h(e, t) {
        var i = t.attr("data-filter"), n = t.position().left, o = t.outerWidth(), s = t.closest(".filter").find(".filter-bar-line");
        e.isotope({filter: i}), s.css({left: n + "px", width: o})
    }
    ...
    function m() {
        if (e("body").hasClass("home")) {
            ...
            "" != t && e("html, body").animate({scrollTop: e("#" + t).offset().top}, 500)
        }
    }
    ...
    function b() {
        ...
        e("html").hasClass("theme-skin-dark") && (a = [{stylers: [{hue: "#ff1a00"}, {invert_lightness: !0}, {saturation: -100}, {lightness: 33}, {gamma: .5}]}, {
            featureType: "water",
            elementType: "geometry",
            stylers: [{color: "#2D333C"}]
        }]), o.data("latitude") && (i = o.data("latitude")), o.data("longitude") && (n = o.data("longitude")), t = new google.maps.LatLng(i, n);
        var r = {zoom: 14, center: t, scrollwheel: !0, mapTypeId: google.maps.MapTypeId.ROADMAP, styles: a};
        o = new google.maps.Map(s, r);
        new Marker({
            map: o, position: t, icon: {
                path: SQUARE_PIN, fillColor: "", fillOpacity: 0, strokeColor: "", strokeWeight: 0
    ...
    function w() {
        var t = e("html"), i = e("body"), n = i.outerWidth(), o = i.outerHeight(), s = [self.pageXOffset || document.documentElement.scrollLeft || document.body.scrollLeft, self.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop];
        t.data("scroll-position", s), t.data("previous-overflow", t.css("overflow")), t.css("overflow", "hidden"), window.scrollTo(s[0], s[1]);
        var a = i.outerWidth() - n, r = i.outerHeight() - o;
        i.css({"margin-right": a, "margin-bottom": r}), t.addClass("lock-scroll")
    }

    function x() {
        var t = e("html"), i = e("body");
        t.css("overflow", t.data("previous-overflow"));
        var n = t.data("scroll-position");
        window.scrollTo(n[0], n[1]), i.css({"margin-right": 0, "margin-bottom": 0}), t.removeClass("lock-scroll")
    }
    ...
    function E() {
        var t = e(".section-contact .row"), i = t.find(".section-box");
        e(window).width() > 767 ? i.css("min-height", t.height() + "px") : i.css("min-height", "0px")
    }

    function I(t, i, n) {
        var o = e('<span class="ripple-effect" />'), s = parseInt(i, 10) - parseInt(t.offset().left, 10), a = parseInt(n, 10) - parseInt(t.offset().top, 10), r = Math.floor(.5 * Math.min(t.height(), t.width())), l = Math.floor(Math.max(t.width(), t.height()) * Math.PI);
        o.css({top: a, left: s, width: r, height: r}).appendTo(t).animate({
            width: l,
            height: l,
            opacity: 0
        }, 500, function () {
    ...
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (L = !0, e("html").addClass("mobile")) : (L = !1, e("html").addClass("desktop")), F = setInterval(function () {
        ...
        if (n.length > 0)for (var o = 0; o < n.length; o++) {
            var s = e(n[o]).closest(".section-box").find(".slider-prev"), r = e(n[o]).closest(".section-box").find(".slider-next");
            e(n[o]).bxSlider({
                auto: !0,
                speed: 800,
                pause: 8e3,
        ...
        var d = e(".post-slider");
        if (d.length > 0)for (var o = 0; o < d.length; o++) {
            var u = e(d[o]).closest(".post-media").find(".slider-prev"), p = e(d[o]).closest(".post-media").find(".slider-next");
            e(d[o]).bxSlider({
                pager: !1,
                controls: !0,
                nextSelector: p,
        ...
        if (f.length > 0)for (var o = 0; o < f.length; o++) {
            var w = e(f[o]), x = w.children().size(), j = !1;
        ...
        F.length > 0 && F.mediaelementplayer({loop: !1, audioHeight: 40, startVolume: .7});
        ...
        D.on("blur", function () {
            ...
            var t = e('<span class="ripple-effect" />'), i = e(this), n = i.width() / 2, o = i.height() / 2, s = Math.floor(.5 * Math.min(i.height(), i.width())), a = Math.floor(1.5 * Math.max(i.width(), i.height()));
            t.css({
                top: o,
                left: n,
                width: s,
            ...
            }).appendTo(i).animate({width: a, height: a, opacity: 0}, 450, function () {
                e(this).remove()
            })
        });
        var z = e(".grid");
        if (z.length > 0) {
            ...
            var W = e(".filter");
            if (W.length > 0) {
                var O = W.find("button"), R = e(".filter-btn-group button:first-child");
            ...
            var H = 0, N = 0, $ = 3, V = e(".grid-more"), U = V.find(".btn"), q = V.find(".ajax-loader");
            U.on("click", function () {
                e.ajax({
                    url: "ajax/portfolio.html", dataType: "html", beforeSend: function () {
                        U.css("display", "none"), q.css("display", "inline-block")
                    }, success: function (t) {
                        if (H = e.grep(e.parseHTML(t), function (t, i) {
                                return e(t).hasClass("grid-item")
                            }).length, H > N)for (var i = 1; $ >= i; i++) {
            ...
            e(".portfolioFancybox").fancybox({
                ...
                autoCenter: !0,
                beforeShow: function () {
                    var t = e(this.element).attr("href"), i = e(".fancybox-portfolio " + t), n = i.find(".inline-embed");
                    if (n.length > 0) {
                        var o = n.data("embed-type"), s = n.data("embed-url");
                        switch (o) {
                            case"image":
                ...
                afterShow: function () {
                    var t = e(this.element).attr("href"), i = e(".fancybox-portfolio " + t);
                    i.addClass("opened")
                },
        ...
        }), e(".mobile-nav").length > 0 && e(".mobile-nav-inner").mCustomScrollbar({theme: "dark"}), e(document).on(A, ".btn-sidebar", function () {
            e("body").hasClass("sidebar-opened") ? k() : T()
        }), e(".sidebar-fixed").length > 0 && e(".widget-area").mCustomScrollbar({theme: "dark"}), e(document).on(A, "#overlay", function () {
        ...
        e(window).scroll(function () {
            ...
            var i, n = e(this).closest(".contactForm"), o = n.find(".input-field"), s = n.find(".contact-name"), a = n.find(".contact-email"), r = n.find(".contact-message"), l = n.find(".contact-response");
    ...
    var N, $ = e(window).width(), V = e(window).height();
    e(window).resize(function () {
        var t = function () {
            M(), g(), E(), l()
        }, i = e(window).width(), n = e(window).height();
